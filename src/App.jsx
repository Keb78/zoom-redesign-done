  ...
  return (
    <div>
      <header className="flex sticky top-0 bg-white py-2">
        ...
        <button className=" border rounded-full text-zoom-blue mr-2 hover:bg-lighter-blue py-2 px-6 hidden md:block">
          Contact Sales
        </button>
        <button className=" border rounded-full text-zoom-blue mr-2 hover:bg-lighter-blue py-2 px-6 hidden md:block">
          Sign Up Free
      ...
      <div className="md:flex md:w-full">
        <div className="md:w-1/2">
          ...
          <div className="">
            <button className="ml-5 bg-zoom-blue rounded-full text-white mt-10 hover:bg-dark-blue py-2 px-6 md:ml-10">
              Plans & Pricing
            </button>
            <button className="ml-5 text-zoom-blue text-lg md:ml-10">
              Sign up, it's free
            </button>
          </div>
        </div>
        <div className="md:w-1/2">
          <img
            className=""
            src="Meetings-Interface-cropped.jpg"
            alt="Image of o women on zoom"
          />
        </div>
      </div>
      ...
      <div className=" bg-darker-blue md:flex md:h-80 md:mt-5">
        ...
        <div className="md:flex-col md:mt-20">
          <h2 className=" text-lighter-blue ml-5 text-3xl font-semibold xl:text-5xl">
            Make work less work
          </h2>
          <p className="text-blue-400 ml-5 mt-3 mr-20 xl:text-xl">
            Securely connect and collaborate so you can work better together. Simple
            to manage and delightful to use, Zoom powers the modern workforce.
          </p>
          <div className="mt-3 pb-5">
            <a
              href=""
              className="text-lighter-blue ml-5 hover:text-white font-semibold xl:text-xl"
            >
      ...
      <div className="md:flex md:w-full md:py-32">
        <div className="md:w-1/2">
          <h2 className="text-gray-700 ml-5 text-2xl font-semibold mt-5 md:ml-10 xl:text-4xl">
            Powering organizations across industries and geographies
          </h2>
          <p className="ml-5 mt-3 text-gray-600 md:ml-10 xl:text-xl">
